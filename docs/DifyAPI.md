...
## [执行 workflow](http://192.168.88.253:18001/app/b91c678c-cb32-4a33-b434-82b16377f0e4/develop#Execute-Workflow)
...
```
curl -X POST 'http://192.168.88.253/v1/workflows/run' \
...
## [获取workflow执行情况](http://192.168.88.253:18001/app/b91c678c-cb32-4a33-b434-82b16377f0e4/develop#get-workflow-run-detail)
...
```
curl -X GET 'http://192.168.88.253/v1/workflows/run/:workflow_run_id' \
...
## [停止响应](http://192.168.88.253:18001/app/b91c678c-cb32-4a33-b434-82b16377f0e4/develop#stop-generatebacks)
...
```
curl -X POST 'http://192.168.88.253/v1/workflows/tasks/:task_id/stop' \
-H 'Authorization: Bearer {api_key}' \
-H 'Content-Type: application/json' \
...
## [上传文件](http://192.168.88.253:18001/app/b91c678c-cb32-4a33-b434-82b16377f0e4/develop#files-upload)
...
```
curl -X POST 'http://192.168.88.253/v1/files/upload' \
--header 'Authorization: Bearer {api_key}' \
...
## [获取 workflow 日志](http://192.168.88.253:18001/app/b91c678c-cb32-4a33-b434-82b16377f0e4/develop#Get-Workflow-Logs)
...
```
curl -X GET 'http://192.168.88.253/v1/workflows/logs'\
 --header 'Authorization: Bearer {api_key}'
```
...
## [获取应用基本信息](http://192.168.88.253:18001/app/b91c678c-cb32-4a33-b434-82b16377f0e4/develop#info)
...
```
curl -X GET 'http://192.168.88.253/v1/info' \
-H 'Authorization: Bearer {api_key}'
```
...
## [获取应用参数](http://192.168.88.253:18001/app/b91c678c-cb32-4a33-b434-82b16377f0e4/develop#parameters)
...
```
 curl -X GET 'http://192.168.88.253/v1/parameters'
```
...
## [获取应用 WebApp 设置](http://192.168.88.253:18001/app/b91c678c-cb32-4a33-b434-82b16377f0e4/develop#site)
